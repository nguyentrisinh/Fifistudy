            ...
            <div className="sign-up-page">
                ...
                <form id="msform">
                    ...
                    <fieldset>
                        ...
                        <input type="button" name="next" className="next action-button" value="Tiếp theo"/>
                    </fieldset>
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <textarea type="text" name="phone" placeholder="Địa chỉ"/>
                        <input type="button" name="next" className="next action-button" value="Tiếp"/>
                    </fieldset>
                    <fieldset>
                        ...
                        <input id="avatar" type="file" hidden={true} value="Upload Avatar"/>

                        <input type="button" name="next" className="previous action-button" value="Trở lại"/>
                        <input type="submit" name="submit" className="submit action-button" value="Xong"/>
                    </fieldset>
                </form>
            </div>
        )
