        ...
        return (
            <div className="menu-mobile">
...

                        {
                            _.has(this.props.userInfo,"data.data.avatar")?
                                    ...
                                    <Link to="/user" className="menu-mobile__item menu-mobile__avatar">
                                        <img className="menu-mobile__img-avatar" src={this.props.userInfo.data.data.avatar?serverDomain + this.props.userInfo.data.data.avatar:defaultAvatar} alt=""/>
                                    </Link>
                ...
                {/*<div className="menu-mobile__row">*/}
                    ...
                    {/*</div>*/}
                {/*</div>*/}
                <SearchContainer classNameContainer = "menu-mobile__item menu-mobile__search" classNameInput = "menu-mobile__input-search">
